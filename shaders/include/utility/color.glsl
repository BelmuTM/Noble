...
vec3 SRGB_TO_WORKING_SPACE(vec3 srgb) {
    return srgbToLinearAlbedoAP1(srgb);
}

vec3 SRGB_TO_WORKING_SPACE_ALBEDO(vec3 srgb) {
    return srgb * SRGB_2_AP1_ALBEDO;
}
